          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/browse?sortBy=popular" className="text-gray-300 hover:text-white">Popular Shows</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="text-gray-300 hover:text-white">Subscribe</Link></li>
              </ul>
            </div>
          </div>
        </div>
