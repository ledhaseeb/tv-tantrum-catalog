...
// Create a router for show submissions
const submissionRouter = express.Router();

// Handle show submissions
submissionRouter.post("/", requireLogin, async (req: Request, res: Response) => {
  try {
    const user = req.user;
...
submissionRouter.get("/user", requireLogin, async (req: Request, res: Response) => {
  try {
    const user = req.user;
